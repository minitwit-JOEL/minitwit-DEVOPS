...
docker run -d --network=minitwit-network -p 5432:5432 --name=minitwit-db --env-file .secrets lukan707/minitwit-joel-db:latest
...
docker run --network=minitwit-network -p 8080:8080 -p 8081:8081 --name=minitwit-api --env-file .secrets lukan707/minitwit-joel-api:latest
