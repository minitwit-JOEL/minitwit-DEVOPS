...
docker run -d --network=minitwit-network -p 3000:3000 --name=minitwit-web -e "API_BASE_URL=https://localhost:8080/" -e "NODE_TLS_REJECT_UNAUTHORIZED=0" lukan707/minitwit-joel-web:latest 
